...
class math_helper
{
    public:
       ...
       double getRandX();
       double getRandY();
       static vector<int> getU_Path(vector < vector < Point> > _inputPoints);//get U path from vector vector point
       static vector<int> getV_Path(vector < vector < Point> > _inputPoints);//get V path from vector vector point
